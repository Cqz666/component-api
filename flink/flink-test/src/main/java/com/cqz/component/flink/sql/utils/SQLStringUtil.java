...
public class SQLStringUtil {
    ...
    /**
     * 处理 com.cqz.component.flink.com.cqz.component.flink.sql 中 "--" 注释，而不删除引号内的内容
     *
     * @param sql 解析出来的 com.cqz.component.flink.com.cqz.component.flink.sql
     * @return 返回无注释内容的 com.cqz.component.flink.com.cqz.component.flink.sql
     */
        ...
        for (int index = 0; index < chars.length; index++) {
            ...
            if ("--".equals(tempSb.toString())) {
                if (inQuotes) {
                    ...
                    while (chars[index] != '\n') {
                        // 判断注释内容是不是行尾或者 com.cqz.component.flink.com.cqz.component.flink.sql 的最后一行
    ...
    public static Object parse(String str, Class clazz) {
        ...
        if (fieldType.equals(Integer.class.getName())) {
            ...
            throw new RuntimeException(
                    "no support field type for com.cqz.component.flink.com.cqz.component.flink.sql. the input type:" + fieldType);
        }
        return object;
    }
