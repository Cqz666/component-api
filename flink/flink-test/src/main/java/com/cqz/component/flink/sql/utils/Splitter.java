...
public class Splitter {
    ...
    /**
     * split com.cqz.component.flink.com.cqz.component.flink.sql to statements
     *
     * <p>Examples:
     *
     * <ul>
     ...
     * </ul>
     *
     * @param string a com.cqz.component.flink.com.cqz.component.flink.sql string
     * @return a com.cqz.component.flink.com.cqz.component.flink.sql list
     */
    ...
    private List<Token> tokenize(String str) {
        ...
        // handle com.cqz.component.flink.com.cqz.component.flink.sql that is not end of ';'
        if (buffer.length() > 0) {
