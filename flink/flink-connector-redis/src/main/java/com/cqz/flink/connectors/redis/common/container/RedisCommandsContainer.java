 ...
 */
package com.cqz.flink.connectors.redis.common.container;
...
public interface RedisCommandsContainer extends Serializable {
    ...
    /**
     * Insert the specified value at the tail of the list stored at key,with TTL,if needed.
     * Setting expire time to key is optional.
     ...
     */
    void rpush(String listName, String value, Integer ttl);

    /**
     * Insert the specified value at the head of the list stored at key,with TTL,if needed.
     * Setting expire time to key is optional.
     * If key does not exist, it is created as empty list before performing the push operation.
     *
     * @param listName Name of the List
     ...
     * @param ttl time to live
     */
    void lpush(String listName, String value, Integer ttl);
