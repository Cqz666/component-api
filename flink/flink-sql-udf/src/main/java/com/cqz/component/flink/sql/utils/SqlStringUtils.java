...
public class SqlStringUtils {
    ...
    public static String asSerializableString(String identifer) {
        String[] obj = identifer.split("\\.");
        return String.format(
                "%s.%s.%s",
                escapeIdentifier(obj[0]),
                escapeIdentifier(obj[1]),
                escapeIdentifier(obj[2]));
    }
